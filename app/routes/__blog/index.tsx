        ...
        <div>
          <div className="absolute left-0 bottom-[600px] w-full before:absolute before:bottom-[-550px] before:h-[600px] before:w-full before:dark:bg-slate-500 before:bg-cyan-200">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
              <path
                className="dark:fill-slate-500 fill-cyan-200"
                fill-opacity="1"
          ...
          <div className="absolute left-0 bottom-[400px] w-full before:absolute before:bottom-[-390px] before:h-[400px] before:w-full before:dark:bg-slate-600 before:bg-cyan-100">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
              <path
                className="dark:fill-slate-600 fill-cyan-100"
                fill-opacity="1"
          ...
          <div className="absolute left-0 bottom-[100px] w-full before:absolute before:bottom-[-100px] before:h-[100px] before:w-full before:dark:bg-slate-700 before:bg-cyan-50">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
              <path
                className="dark:fill-slate-700 fill-cyan-50"
                fill-opacity="1"
