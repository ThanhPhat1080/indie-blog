...
export default function PostPage() {
  ...
  return (
    <div className="flex">
      <div className="sticky top-0 h-[calc(_100vh_-_50px_)] max-h-screen w-96 border-spacing-2 overflow-y-auto overflow-x-hidden border-r-2 border-gray-300 pt-5 pb-0 xl:w-96">
        ...
        <div className="sticky bottom-0 left-0 w-full border-t-2 border-gray-400 bg-slate-800 p-6">
          <Link to={"./../formEditor-test"}>
            <button className="m-auto inline-flex w-full items-center justify-center rounded-md bg-green-500 p-2 text-center text-xl text-white duration-300 ease-in-out hover:scale-110 hover:bg-green-600 focus:scale-110 active:scale-105 active:bg-green-800">
              <svg
