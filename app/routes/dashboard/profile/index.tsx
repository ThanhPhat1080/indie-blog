  ...
  return (
    <div className="flex h-full w-full flex-col gap-4">
        ...
        {!isEmptyOrNotExist(user.twitter) && (
          <p className="my-2 inline-flex items-center gap-2">
            ...
            <a
              ...
              className="flex-1 text-sky-600 hover:underline"
              target="blank"
            >
              <em>@{user.twitter}</em>
            </a>
      ...
      <Link
        ...
        prefetch="intent"
        title="Edit profile"
        className="w-full rounded bg-sky-700 py-2 px-4 text-center font-bold text-white hover:bg-sky-600 focus:bg-sky-400"
      >
        Edit profile
      </Link>
    </div>
